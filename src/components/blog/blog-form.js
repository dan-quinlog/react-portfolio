...
export default class BlogForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      content: "",
      featured_image: "",
      apiUrl: "https://daniel.devcamp.space/portfolio/portfolio_blogs",
      apiAction: 'post'
    };
  ...
  deleteImage(imageType) {
    axios
      ...
      .catch(error => {
        console.log("blog deleteImage error", error);
      });
  }
  ...
  componentWillMount() {
    if (this.props.editMode) {
      this.setState({
        ...
        apiUrl: `https://daniel.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,
        apiAction: 'patch'
      });
    }
  }
  ...
  handleRichTextEditorChange(content) {
    //content will be a string value
    this.setState({ content });
    //you can use just this one word because the args are named the same as the state.key
  }
